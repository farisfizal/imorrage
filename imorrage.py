...
print("What is your image file's name? (including the extension): ")
file_name = input()
...
if presence == True:
    print("There is hemorrhaging present in this cranial CT scan.")

    if lat_R == True:
        print("The hemorrhaging is primarily in the right hemisphere of the patient's brain.")
    elif lat_L == True:
        print("The hemorrhaging is primarily in the left hemisphere of the patient's brain.")
    elif lat_R == True and lat_L == True:
        print("The hemorrhaging is present in both hemispheres of the patient's brain.")
    else:
        print("The hemorrhaging is not localized to one or both hemispheres.")
    ...
    # VRs is an abbreviation for vascular regions

    plt.savefig(f'{filename_split[0]}_out_VRs.png')
    ...
    print("There is no hemorrhaging present in this cranial CT scan.")
